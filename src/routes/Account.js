                ...
                <div className={styles.card}>
                    ...
                    <div className={styles.userDetails} style={{textAlign: "left"}}>
                        ...
                        <div className={styles.password}>
                            <Button className={styles.button} variant="contained" fullWidth>Edit</Button>
                            <Button className={styles.button} variant="contained" fullWidth>Change Password</Button>
                        </div>
                    </div>
                    <div className={styles.bottom}>
                        ...
                        <div className={styles.billing}>
                            <div className={styles.billingBox}>
                                <h2 className={styles.editBilling}>Billing 
