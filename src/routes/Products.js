...
// Mock data
const products = [
    { id: 1, img: 'https://via.placeholder.com/300', title: 'Product 1', desc: 'This is product 1' },
    { id: 1, img: 'https://via.placeholder.com/300', title: 'Product 1', desc: 'This is product 1' },
    { id: 1, img: 'https://via.placeholder.com/300', title: 'Product 1', desc: 'This is product 1' },
    { id: 1, img: 'https://via.placeholder.com/300', title: 'Product 1', desc: 'This is product 1' },
    { id: 1, img: 'https://via.placeholder.com/300', title: 'Product 1', desc: 'This is product 1' },
                    ...
                    <div className="flex items-center justify-center min-h-screen">
                        ...
                        <div className="bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div className="text-center">
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <h3 className=" text-2xl font-medium text-gray-900 mb-6" id="modal-title">
                                            Add Product
                                        </h3>
                                        <div className="mt-2">
                            ...
                            <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                <button onClick={handleSubmit} type="button" className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-gray-500 text-base font-medium text-white hover:bg-gray-700 focus:outline-none sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                                    Submit
                                </button>
            ...
            <div className={`p6 ${styles.products_wrapper}`}>
                ...
                <div className="mt-4">
                    <div className="flex space-x-4 items-center">
                        ...
                        <input type="search" className="w-30 px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Price Range" />
                        <input type="text" className="w-30 px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Tags" />
                    </div>
                </div>
